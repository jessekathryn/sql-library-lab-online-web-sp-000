...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(character_books) FROM character_books JOIN characters ON character_books.character_id = characters.id ORDER BY characters.name DESC;"
end
